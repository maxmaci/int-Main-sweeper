	...
	while (incognite.size() != 0)
	{
		...
		while (incognite.size() != 0 && coda.size() != 0)
		{
			...
			if (partita._campo_visibile().indici_leciti(cella.first, cella.second) && !trova_elemento(incognite_separate_regione, cella) && trova_elemento(incognite, cella)) //   && partita.conta_numeri_vicini(cella.first, cella.second) == a
			{
				...
				{
					if (partita._campo_visibile().indici_leciti(cella.first, cella.second - 1) && partita._campo_visibile()[cella.first][cella.second - 1] == -2) coda.push(Coord(cella.first - 1, cella.second - 1)); // NORD-OVEST 
					else coda.push(Coord(cella.first, cella.second - 1)); // OVEST
					if (partita._campo_visibile().indici_leciti(cella.first, cella.second + 1) && partita._campo_visibile()[cella.first][cella.second + 1] == -2) coda.push(Coord(cella.first - 1, cella.second + 1)); // NORD-EST
					else coda.push(Coord(cella.first, cella.second + 1)); // EST
				}
				if (partita._campo_visibile().indici_leciti(cella.first + 1, cella.second) && partita._campo_visibile()[cella.first + 1][cella.second] > 0)
				{
					if (partita._campo_visibile().indici_leciti(cella.first, cella.second - 1) && partita._campo_visibile()[cella.first][cella.second - 1] == -2) coda.push(Coord(cella.first + 1, cella.second - 1)); // SUD-OVEST
					else coda.push(Coord(cella.first, cella.second - 1)); // OVEST
					if (partita._campo_visibile().indici_leciti(cella.first, cella.second + 1) && partita._campo_visibile()[cella.first][cella.second + 1] == -2) coda.push(Coord(cella.first + 1, cella.second + 1)); // SUD-EST
					else coda.push(Coord(cella.first, cella.second + 1)); // EST
				}
				if (partita._campo_visibile().indici_leciti(cella.first, cella.second - 1) && partita._campo_visibile()[cella.first][cella.second - 1] > 0)
				{
					if (partita._campo_visibile().indici_leciti(cella.first - 1, cella.second) && partita._campo_visibile()[cella.first - 1][cella.second] == -2) coda.push(Coord(cella.first - 1, cella.second - 1)); // NORD-OVEST
					else coda.push(Coord(cella.first - 1, cella.second)); // NORD
					if (partita._campo_visibile().indici_leciti(cella.first + 1, cella.second) && partita._campo_visibile()[cella.first + 1][cella.second] == -2) coda.push(Coord(cella.first + 1, cella.second - 1)); // SUD-OVEST
					else coda.push(Coord(cella.first + 1, cella.second)); // SUD
				}
				if (partita._campo_visibile().indici_leciti(cella.first, cella.second + 1) && partita._campo_visibile()[cella.first][cella.second + 1] > 0)
				{
					if (partita._campo_visibile().indici_leciti(cella.first - 1, cella.second) && partita._campo_visibile()[cella.first - 1][cella.second] == -2) coda.push(Coord(cella.first - 1, cella.second + 1)); // NORD-EST
					else coda.push(Coord(cella.first - 1, cella.second)); // NORD
					if (partita._campo_visibile().indici_leciti(cella.first + 1, cella.second) && partita._campo_visibile()[cella.first + 1][cella.second] == -2) coda.push(Coord(cella.first + 1, cella.second + 1)); // SUD-EST
					else coda.push(Coord(cella.first + 1, cella.second)); // SUD
				}
				// angoli
				...
				{
					if (partita._campo_visibile().indici_leciti(cella.first, cella.second - 1) && partita._campo_visibile()[cella.first][cella.second - 1] == -2) coda.push(Coord(cella.first, cella.second - 2)); // OVEST-OVEST
					else coda.push(Coord(cella.first, cella.second - 1)); // OVEST
					if (partita._campo_visibile().indici_leciti(cella.first - 1, cella.second) && partita._campo_visibile()[cella.first - 1][cella.second] == -2) coda.push(Coord(cella.first - 2, cella.second)); // NORD-NORD
					else coda.push(Coord(cella.first - 1, cella.second)); // NORD	
				}
				if ((partita._campo_visibile().indici_leciti(cella.first - 1, cella.second + 1) && partita._campo_visibile()[cella.first - 1][cella.second + 1] > 0))
				{
				...
				if ((partita._campo_visibile().indici_leciti(cella.first + 1, cella.second + 1) && partita._campo_visibile()[cella.first + 1][cella.second + 1] > 0))
				{
					...
					if (partita._campo_visibile().indici_leciti(cella.first + 1, cella.second) && partita._campo_visibile()[cella.first + 1][cella.second] == -2) coda.push(Coord(cella.first + 2, cella.second)); // SUD-SUD
					else coda.push(Coord(cella.first + 1, cella.second)); // SUD
				}
